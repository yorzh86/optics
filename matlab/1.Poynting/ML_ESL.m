...
for ii = 1:length(theta_i)
    ...
    [A_TM{ii}, B_TM{ii}] = ABcoeff_aniso_multilayer(diff, layers, wl, ep_O, ep_E, kx(ii));
    [A_EMTp{ii},B_EMTp{ii}] = ABcoeff_aniso_multilayer(diff_EMT, 3, wl, ep_3O, ep_3E, kx(ii));
